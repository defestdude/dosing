...
class BookRead extends StatefulWidget {
  String pageTitle;
  int bookType;
  BookRead(this.bookType, this.pageTitle);  //constructor

  @override
  _BookReadState createState() => _BookReadState(this.bookType, this.pageTitle);
}
...
class _BookReadState extends State<BookRead> {
  ...
  loadDocument() async {
    if (bookType == 1) {
      ...
      pdfasset = "assets/documents/book_4.pdf";
    }         
    else {
      pdfasset = "assets/documents/book_5.pdf";
    }
